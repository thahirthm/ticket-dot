        ...
        <div className="container legal-container">
            <div className="legal-sections">
              <section>
                ...
                <p className="mt-2">By accessing or using TicketDot, you agree to the practices described in this Privacy Policy.</p>
              </section>
              ...
              <section>
                ...
                <h3 className="legal-subsection-title mt-4 font-semibold text-lg">Personal Information:</h3>
                ...
                <h3 className="legal-subsection-title mt-4 font-semibold text-lg">Booking Information:</h3>
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>Bus operator</li>
                ...
                <h3 className="legal-subsection-title mt-4 font-semibold text-lg">Payment Information</h3>
                <p className="mt-2">Payments are securely processed through trusted third-party payment gateways. TicketDot does not store your debit card, credit card, UPI PIN, or banking credentials.</p>

                <h3 className="legal-subsection-title mt-4 font-semibold text-lg">Device &amp; Technical Information</h3>
                ...
                <h3 className="legal-subsection-title mt-4 font-semibold text-lg">Location Information</h3>
                <p className="mt-2">With your permission, TicketDot may access your location to:</p>
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>Show nearby boarding points</li>
                  <li>Improve route recommendations</li>
                  <li>Enhance your overall booking experience</li>
                </ul>
                <p className="mt-2">You can disable location access at any time through your device settings.</p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-2">
                  <li><strong>Bus Operators:</strong> To confirm and manage your ticket booking.</li>
                  <li><strong>Payment Service Providers:</strong> To securely process payments and refunds.</li>
                  <li><strong>Technology Partners:</strong> Cloud hosting, analytics, SMS, email, and notification providers that help us operate our services.</li>
                  <li><strong>Legal Authorities:</strong> When required by law, court order, or government request.</li>
                  <li><strong>Business Transfers:</strong> If TicketDot is involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">While we strive to protect your data, no online system can guarantee 100% security.</p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">When your data is no longer required, it will be securely deleted or anonymized.</p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">These services have their own privacy policies, and TicketDot is not responsible for their privacy practices.</p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">Any significant changes will be communicated through our website, mobile application, or other appropriate channels. Continued use of TicketDot after changes become effective constitutes your acceptance of the revised Privacy Policy.</p>
              </section>
